...
function buscaProduto() {
    url = document.getElementById("txtAPILink").value;
    if (url.trim() != "") {
...
$(document).ready(function () {
    $("body").on("click", "button", function () {
        ...
        if (this.id.indexOf("btnCadastrarProduto_") > -1) {
            ...
            var produto = new Produto(document.getElementById("txtId_c" + txtID).value, document.getElementById("txtDescricao_c" + txtID).value, document.getElementById("txtPreco_c" + txtID).value, document.getElementById("txtCategoria_c" + txtID).value);
